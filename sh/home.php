...
<?php
        ...
        include 'conn.php';
        $qry="SELECT `uid`, `fullname`, `email`, `age`, `religion`, `gender`,`code`,`pic` FROM `users`;";
...
?>
         ...
         <tr>
          ...
          <td> <button class="btn-primary btn"> <a href="cvshow.php?uid=<?php echo $res['uid']; ?>" class="text-white"> Show All Info </a> </button> </td>
